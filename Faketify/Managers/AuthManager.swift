...
final class AuthManager {
    ...
    struct Constants {
        ...
        static let redirectURI = "faketify://callback" // Any link works
    ...
    public func handleRedirectURL(_ url: URL) {
        guard let components = URLComponents(url: url, resolvingAgainstBaseURL: false),
            ...
            print("⚠️ Không tìm thấy code trong redirect URL: \(url)")
            return
        }
...
extension Notification.Name {
    static let didSignInNotification = Notification.Name("didSignInNotification")
}
