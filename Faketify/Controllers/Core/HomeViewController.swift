...
class HomeViewController: UIViewController {
    ...
    private func configureCollectionView() {
        ...
        collectionView.register(UINib(nibName: "NewReleaseCollectionViewCell", bundle: .main),
                                forCellWithReuseIdentifier: NewReleaseCollectionViewCell.identifier)
        collectionView.register(UINib(nibName: "PlaylistsCollectionViewCell", bundle: .main),
                                forCellWithReuseIdentifier: PlaylistsCollectionViewCell.identifier)
        collectionView.register(UINib(nibName: "TrackCollectionViewCell", bundle: .main),
